...
class Student {
    ...
    Student(String name, int sId, int daysattended) {
        this.name = name;
        this.sId = sId;
...
class Classroom{
    ...
    public void updateDaysattended(int sId, int daysattended){
		int count=0;
		...
		if(stcheck==true){
            ...
            System.out.println("Days attended updated for student ID: " + sId);
        }else{
